...
def get_account_credentials(region: str) -> str:
    r = region.upper()
    if r == "IND":
        return "uid=4385259561&password=Mrvishal_9IZGKBTL6MU"
    elif r == "BD":
        return "uid=4429663934&password=DEV_V0H6D_BY_SPIDEERIO_GAMING_FRHSZ"
    elif r in {"BR", "US", "SAC", "NA"}:
        return "uid=4253808271&password=BY_GRIZLY-TEV1ML6A4-GRIZLY"
    else:
        return "uid=4422509376&password=DEV_5SN0N_BY_SPIDEERIO_GAMING_IOCFC"
